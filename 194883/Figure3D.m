...
% *************************************************************************
% This script reproduces Figure 3D of the manuscript.
%   Florian Raudies, 01/30/2014, Boston University.
%   This script will run for about 40 minutes.
% *************************************************************************
...
for iRun = 1:nRun,
    ...
    for iHidden = 1:nNHidden,
        ...
        dcl = DoubleContextLearnerDBN(LetterLabel,NumberLabel,NHidden(iHidden),nLayer);
...
figure('Position',[50 50 600 500],'PaperPosition',[2 2 5 4],'Name','D');
