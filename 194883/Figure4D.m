...
% *************************************************************************
% This script reproduces Figure 4D of the manuscript.
...
LetterLabel = {'A','B','C','D'};
NumberLabel = {'1','2','3','4'};
dcl         = DoubleContextLearnerDBNaLP(LetterLabel,NumberLabel,nHidden,nLayer)
...
figure('Position',[50 50 600 600],'PaperPosition',[2 2 5 6],'Name','4D');
